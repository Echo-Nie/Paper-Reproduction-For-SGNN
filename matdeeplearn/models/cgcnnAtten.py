...
class CGCNN(torch.nn.Module):
    def __init__(
        ...
        # 添加输出注意力机制
        self.attention = torch.nn.MultiheadAttention(embed_dim=dim1, num_heads=4)
    ...
    def forward(self, data):
        ...
        ## 使用输出注意力机制
        out = out.unsqueeze(0)  # 增加一个维度以适应注意力层
        out, _ = self.attention(out, out, out)  # 使用多头注意力机制
        out = out.squeeze(0)  # 移除增加的维度
