...
![img](E:\deeperGATGNN\imagesFormd\ModelStructure.png)
...
![Table2](E:\deeperGATGNN\imagesFormd\table2.png)
...
5. **参数数量与模型复杂度：** DeeperGATGNN 是最节省参数的模型，即使有 50 个 GC 层，参数数量也低于 180 万个。而 MEGNet 和 DeeperMEGNet 的参数数量超过 900 万个
   ...
   ![Table2](E:\deeperGATGNN\imagesFormd\MAEcomparison.png)
...
![image-20250207184423257](E:\deeperGATGNN\imagesFormd\fig4.png)



# 5 - Scalability comparison

![image-20250207184445350](E:\deeperGATGNN\imagesFormd\fig7.png)
...
![image-20250207202018968](E:\deeperGATGNN\imagesFormd\fs3.png)
